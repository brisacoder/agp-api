...
class TestFireForget(unittest.IsolatedAsyncioTestCase):
    ...
    async def _publish_message_test(self, payload):
        ...
        # create a session
        session = await gateway_container.gateway.create_ff_session(agp_bindings.PyFireAndForgetConfiguration())
